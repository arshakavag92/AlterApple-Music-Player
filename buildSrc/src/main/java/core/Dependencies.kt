...
object Dependencies {
    ...
    object AndroidXLibraries {
        ...
        val constraint_layout = "androidx.constraintlayout:constraintlayout:${Versions.androidx_constraintlayout_version}"
        val preferences = "androidx.preference:preference:${Versions.androidx_preferences_version}"
        val preferences_ktx = "androidx.preference:preference-ktx:${Versions.androidx_preferences_version}"
    ...
    object ThirdPartyLibs {
        ...
        const val retrofit_converter_scalars = "com.squareup.retrofit2:converter-scalars:${Versions.retrofit_scalars_factory_version}"
        const val retrofit_logging_interceptor = "com.squareup.okhttp3:logging-interceptor:${Versions.retrofit_logging_interceptor_version}"
    ...
    object Kotlin {
        ...
        val coroutines = "org.jetbrains.kotlinx:kotlinx-coroutines-android:${Versions.lib_coroutines_version}"
    }
    ...
    object Tests {
        ...
        val espresso_extension_version = "androidx.test.espresso:espresso-core:${Versions.espresso_extension_version}"
